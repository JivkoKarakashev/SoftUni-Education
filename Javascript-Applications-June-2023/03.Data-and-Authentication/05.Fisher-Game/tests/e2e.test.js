...
const host = 'http://localhost:5500/APPLICATIONS/03.Data-and-Authentication/05.Fisher-Game/src/'; // Application host (NOT service host - that can be anything)
...
describe('E2E tests', function () {
  // Setup
  this.timeout(/*DEBUG ?*/ 8000/* : 7000*/);
  before(
    async () =>
      (browser = await chromium.launch(
        /*DEBUG ?*/ { headless: false, slowMo: 1000 }/* : {}*/
      ))
  );
