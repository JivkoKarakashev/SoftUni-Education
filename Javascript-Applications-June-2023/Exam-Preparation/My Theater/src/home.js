...
const homePageTemplate = (theatersArr) => html`
    <section class="welcomePage">
        ...
        <div id="events">
            ...
            <div class="theaters-container">
                ...
                <!--Created Events-->
                ${theatersArr.length != 0 ? theatersArr.map((theater) => html`
                <div class="eventsInfo">
                    ...
                    <div class="info">
                        ...
                        <div class="info-buttons">
                            <a class="btn-details" href="/dashboard/${theater['_id']}">Details</a>
                        </div>
                    </div>
                </div>
                `) : null}
                <!--No Theaters-->
                ${theatersArr.length == 0 ? html`<h4 class="no-event">No Events Yet...</h4>` : null}
            </div>
        </div>
    </section>
`;
...
export async function homePage(ctx) {
    // console.log(ctx);
    const theatersArr = await get('/data/theaters?sortBy=_createdOn%20desc&distinct=title');
    // const theatersArr = [];
    // console.log(theatersArr);
    ctx.render(homePageTemplate(theatersArr));
}