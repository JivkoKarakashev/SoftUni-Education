...
describe('E2E tests', function () {
  ...
  describe('Forum', () => {
    ...
    it('Check post title', async () => {
      ...
      await page.waitForSelector(".theme-title", { timeout: interval });
    ...
    it('Check username', async () => {
      ...
      await page.waitForSelector(".comment", { timeout: interval });
    ...
    it('Check is comment field is available', async () => {
      ...
      await page.waitForSelector(".answer-comment", { timeout: interval });
    ...
    it('Check cancel button', async () => {
      ...
      await page.waitForSelector('.container .new-topic-border >> form', { timeout: interval });
      await page.fill('.new-topic-title >> [name="topicName"]', data.title);
      await page.fill('.new-topic-title >> [name="username"]', data.username);
      await page.fill('.new-topic-content >> [name="postText"]', data.content);
      ...
      await page.waitForSelector(".new-topic-title", { timeout: interval });
